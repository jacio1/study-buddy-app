  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (authError) {
        ...
        alert(
          "Не удалось удалить аккаунт. Пожалуйста, свяжитесь с поддержкой.",
        );
        return;
      }
      ...
      alert(
        "Произошла ошибка при удалении аккаунта. Попробуйте позже или свяжитесь с поддержкой.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <main className="mb-20 container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="rounded-2xl border border-border p-8 mb-5 bg-card">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground flex items-center gap-1.5">
                  <Clock className="h-3.5 w-3.5" />С нами с {memberSince}
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div
                key={stat.label}
                className="flex flex-col items-center gap-1.5 py-5 rounded-xl border border-border text-center bg-muted"
              >
        ...
        <div className="flex gap-2 mb-4">
          ...
          >
            ...
            {completedSessions.length > 0 && (
              <span className="px-1.5 py-0.5 rounded-full bg-muted-foreground/20 text-muted-foreground text-xs font-bold">
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap mb-0.5">
                        ...
                        <span
                          className={cn(
                            "px-2 py-0.5 rounded-full text-[11px] font-medium border shrink-0",
                            levelColors[listing.level] ??
            ...
            {completedSessions.length === 0 ? (
              ...
              <div className="space-y-2">
                {completedSessions.map((sess) => (
                  ...
                  >
                    <div className="w-9 h-9 rounded-xl bg-muted-foreground/20 flex items-center justify-center shrink-0">
        ...
        <div className="mt-4 pt-4 border-t border-border">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-destructive hover:text-destructive/90 bg-destructive/10 hover:bg-destructive/20 transition-all"
          >
            <Trash2 className="h-4 w-4" />
            Удалить аккаунт
          </button>
