              ...
              <form onSubmit={handleSearch} className="flex-1 mx-4">
                <div className="flex items-center gap-0 group/search">
                  ...
                  <Button
                    type="submit"
                    size="icon"
                    className="h-12 w-12 rounded-r-full rounded-l-none border border-l-0 border-border transition-colors shrink-0 group-focus-within/search:border-primary"
                  >
            ...
            {!isMobile && (
              <div className="flex items-center gap-2">
                <Button
                  ...
                  size="icon"
                  className="h-12 w-12 rounded-xl shrink-0 sm:w-auto sm:px-4"
                >
                ...
                <button
                  ...
                  title="Сообщения"
                  className={cn(
                    "relative p-2.5 rounded-xl border transition-all h-12 w-12 flex items-center justify-center",
                    isMessages
                    ...
                    <div className="absolute right-0 top-full mt-2 w-52 rounded-xl border border-border shadow-2xl shadow-black/30 overflow-hidden z-50 bg-card">
                      ...
                      <div className="py-1">
                        ...
                        >
                          ...
                          {unreadDMs > 0 && (
                            <span className="ml-auto min-w-5 h-5 rounded-full bg-primary text-primary-foreground text-[10px] font-bold flex items-center justify-center px-1">
                              {unreadDMs > 9 ? "9+" : unreadDMs}
                            </span>
                          )}
                        </button>
              ...
              <form onSubmit={handleSearch} className="w-full">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="w-full h-12 pl-12 pr-10 bg-muted border border-border text-foreground placeholder:text-muted-foreground rounded-full text-base"
                  />
                  {searchQuery && (
                    <button
                      type="button"
                      onClick={clearSearch}
                      className="absolute right-3 top-1/2 -translate-y-1/2 h-6 w-6 flex items-center justify-center rounded-full hover:bg-muted-foreground/20 transition-colors"
                    >
